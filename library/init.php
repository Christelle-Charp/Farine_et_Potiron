...
//récupère le tableau $_SESSION avec sa dernière valeur connue
...
function autoLoadModele($class){
    ...
    $domain = $path[0];
    if ($domain != "modeles") return;    // cette fonction ne gere que les classes contenues dans le dossier modeles
    ...
    //On vérifie que le fichier du nom de la classe existe bien dans le dossier modeles
    if(file_exists($dir)) {
...
global $bdd;
$bdd = new PDO("mysql:host=172.18.0.1;dbname=farine&potiron;charset=UTF8", "farine&potiron", "farine&potiron");
